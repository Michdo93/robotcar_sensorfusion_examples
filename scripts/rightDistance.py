...
class RightDistance(object):
    ...
    def __init__(self, robot_host):
        ...
        self.ultrasonicFrontSub = message_filters.Subscriber(self.robot_host + '/ultrasonic/front/right/distance', Range)
        self.ultrasonicRearSub = message_filters.Subscriber(self.robot_host + '/ultrasonic/rear/right/distance', Range)
    ...
    def callback(self, ultrasonicFrontData, ultrasonicRearData):
        ...
        #rospy.loginfo("rightFrontUltrasonic: " + ultrasonicFrontMsg)
        #rospy.loginfo("rightRearUltrasonic: " + ultrasonicRearMsg)

        self.applyKF()

if __name__ == '__main__':
    # Initialize the node and name it.
    node_name = re.sub("-", "_", socket.gethostname()) + "_RightDistanceSubscriber"
    rospy.init_node(node_name, anonymous=False)
    
    right = RightDistance("robotcar")
