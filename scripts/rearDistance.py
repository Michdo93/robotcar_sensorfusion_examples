...
class RearDistance(object):
    ...
    def __init__(self, robot_host):
        ...
        self.irSub = message_filters.Subscriber(self.robot_host + '/infrared/rear/distance', Range)
        self.tofSub = message_filters.Subscriber(self.robot_host + '/time_of_flight/rear/distance', Range)
        self.ultrasonicSub = message_filters.Subscriber(self.robot_host + '/ultrasonic/rear/distance', Range)
    ...
    def callback(self, irData, tofData, ultrasonicData):
        ...
        #rospy.loginfo("rearInfrared: " + irMsg)
        #rospy.loginfo("rearToF: " + tofMsg)
        #rospy.loginfo("rearUltrasonic: " + ultrasonicMsg)

        self.applyKF()

if __name__ == '__main__':
    # Initialize the node and name it.
    node_name = re.sub("-", "_", socket.gethostname()) + "_RearDistanceSubscriber"
    rospy.init_node(node_name, anonymous=False)
    
    rear = RearDistance("robotcar")
